<div class="tab card" id="step-3" style="height: 85%;">
    <div class="card-header">
        <h4 class="card-title">Detail Kunjungan</h4>
    </div>
    <div class="card-body" style="height: 100%; padding: 0;">
        <ul class="nav nav-tabs" id="tab" role="tablist" aria-orientation="vertical">
        ...
        <div class="tab-content" id="tab-tabContent" style="height: 100%;">
            <div style="height:100%;" class="tab-pane fade active show" id="tab-rekammedis" role="tabpanel"
                aria-labelledby="tab-rekammedis-tab">
                <p style="text-align: center;margin-top: 25%;"><i class="bi bi-calendar2-check-fill" style="font-size: 88px;"></i> <br> Tidak ada Data Rekam Medis pada Pasien Ini</p>
            </div>
